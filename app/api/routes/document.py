...
from app.models.schemas import (
    DocumentUploadResponse, DocumentMetadata, ProcessingStatus,
    ErrorResponse
)
...
async def process_document_background(
    ...
    try:
        ...
        text = await document_service.extract_text(
            document_id, file_path, metadata.document_type
        )
        
        # Update metadata with text statistics
        metadata.word_count = len(text.split())
        metadata.processing_timestamp = metadata.upload_timestamp  # Use current time in production
...
async def upload_document(
    ...
    try:
        ...
        # Upload document
        metadata = await document_service.upload_document(file_content, file.filename)
