...
async def summarize_text(
    ...
    try:
        ...
        if request.text:
            ...
            raise HTTPException(status_code=400, detail="Either text or document_id must be provided")
...
async def answer_question(
    ...
    try:
        ...
        if request.context:
            ...
            raise HTTPException(status_code=400, detail="Either context or document_id must be provided")
        
        # Answer question
        qa_response = await nlp_service.answer_question(
            request.question,
            context_text
        )
...
async def extract_entities(
    ...
    try:
        ...
        logger.info(f"Named entities extracted successfully")
        return ner_response
