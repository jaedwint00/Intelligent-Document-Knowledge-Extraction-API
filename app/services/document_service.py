...
from app.models.schemas import DocumentType, ProcessingStatus, DocumentMetadata, TextChunk
...
class DocumentService:
    ...
    async def extract_text(self, document_id: str, file_path: str, document_type: DocumentType) -> str:
